...
Hello, dear user.
If, like me, you're irritated by constantly switching keyboard layouts (three or more), then my app is for you! In semi-automatic mode, pressing QQ switches the first selected layout within 0.4 seconds (400 ms), and the corresponding layout will be activated. WW, EE, and the same result for the next two layouts. Hotkeys and the time between clicks can be changed in the settings. Thank you for downloading and supporting us! Enjoy!
